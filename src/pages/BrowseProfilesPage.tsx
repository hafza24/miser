          ...
          <div className="bento-tile p-4 md:col-span-4">
            ...
            <div className="relative">
              ...
              <Input
                ...
                placeholder="Search by alias, bio, interests, character..."
              ...
              {modeInterests.map((interest) => {
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all duration-200 ease-out ${
                      isSelected
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="flex items-center gap-2">
                ...
                <Select value={filterCountry || 'all'} onValueChange={(v) => setFilterCountry(v === 'all' ? '' : v)}>
                  <SelectTrigger className="h-9 text-xs flex-1"><SelectValue placeholder="All countries" /></SelectTrigger>
                  <SelectContent>
              ...
              <div className="flex items-center gap-2">
                ...
                <Select value={filterAvailability || 'all'} onValueChange={(v) => setFilterAvailability(v === 'all' ? '' : v)}>
                  <SelectTrigger className="h-9 text-xs flex-1"><SelectValue placeholder="Any time" /></SelectTrigger>
                  <SelectContent>
              ...
              <div className="flex items-center gap-2">
                ...
                <Select value={filterGender || 'all'} onValueChange={(v) => setFilterGender(v === 'all' ? '' : v)}>
                  <SelectTrigger className="h-9 text-xs flex-1"><SelectValue placeholder="All genders" /></SelectTrigger>
                  <SelectContent>
              ...
              <div className="flex flex-wrap gap-1.5">
                {PERSONALITY_OPTIONS.map((trait) => (
                  <Badge
                    ...
                    className="cursor-pointer select-none transition-colors text-[11px] px-2.5 py-0.5"
        ...
        {loading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="bento-tile p-4 h-32 animate-pulse" />
            ))}
          </div>
        ) : filtered.length === 0 ? (
          <EmptyState
            ...
            description="Try selecting different interests or adjusting your filters."
            action={
              hasActiveFilters ? (
